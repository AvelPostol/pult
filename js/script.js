...
$('.btn-add-no-yet').click(function(event) {
   if(!($('.count').hasClass('count-done'))){
      $('.count').toggleClass('count-done');
   }
   if(!($('.btnforadd').hasClass('btn-add-yet'))){
      $('.btnforadd').toggleClass('btn-add-yet');
   }


});

$('.sort-buf-button-position__1').prependTo($('.sort-button-position-choice'));

$('.sort-button-position__1').click(function(event) {
   $('.sort-buf-button-position__1').prependTo($('.sort-button-position-choice'));
   $('.sort-buf-button-position__2').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__3').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__4').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__5').prependTo($('.sort-buf'));
   $('.sort-button-position').toggleClass('hidden');
   $('.sort-cont').removeClass('sort-cont__active');
});
$('.sort-button-position__2').click(function(event) {
   $('.sort-buf-button-position__2').prependTo($('.sort-button-position-choice'));
   $('.sort-buf-button-position__1').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__3').prependTo($('.sort-buf-'));
   $('.sort-buf-button-position__4').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__5').prependTo($('.sort-buf'));
   $('.sort-button-position').toggleClass('hidden');
...
$('.sort-button-position__3').click(function(event) {
   $('.sort-buf-button-position__3').prependTo($('.sort-button-position-choice'));
   $('.sort-buf-button-position__1').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__2').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__4').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__5').prependTo($('.sort-buf'));
...
$('.sort-button-position__4').click(function(event) {
   $('.sort-buf-button-position__4').prependTo($('.sort-button-position-choice'));
   $('.sort-buf-button-position__2').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__3').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__1').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__5').prependTo($('.sort-buf'));
...
$('.sort-button-position__5').click(function(event) {
   $('.sort-buf-button-position__5').prependTo($('.sort-button-position-choice'));
   $('.sort-buf-button-position__2').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__3').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__4').prependTo($('.sort-buf'));
   $('.sort-buf-button-position__1').prependTo($('.sort-buf'));
